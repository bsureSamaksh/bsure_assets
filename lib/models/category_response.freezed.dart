...
class _$CategoryResponseImpl
  ...
  _$CategoryResponseImpl({required final List<Category> categories})
...
abstract class _CategoryResponse implements CategoryResponse {
  factory _CategoryResponse({required final List<Category> categories}) =
...
class _$CategoryImpl with DiagnosticableTreeMixin implements _Category {
  _$CategoryImpl({required this.name, required this.image});
...
abstract class _Category implements Category {
  factory _Category({required final String name, required final String image}) =
      _$CategoryImpl;
